  ...
  const developers = [
    {
      ...
      designation: "Full Stack Web Developer",
      image: "./harpal.jpg",
      githubLink: "https://github.com/harpalmodasiya",
      linkedinLink: "https://www.linkedin.com/authwall?trk=bf&trkInfo=AQFP3P54NctPBwAAAZY_wc4geaMJehEQtVFY3WLuMdAkzYcI7AUuVBFdFSadsQ3HpLM3RzD5NFah-PyEwkYAK20qnp_hBRseMnoXQFONxmvL1d0xTCJAQXbH0d_ZQiceFTtfwHc=&original_referer=&sessionRedirect=https%3A%2F%2Fwww.linkedin.com%2Fin%2Fharpalmodasiya%3Futm_source%3Dshare%26utm_campaign%3Dshare_via%26utm_content%3Dprofile%26utm_medium%3Dandroid_app"
    }
    // {
    //   name: "Meet Gondaliya",
    //   designation: "Full Stack Web Developer",
    //   image: "./meet.jpg",
    //   // githubLink: "https://github.com/harpalmodasiya",
    //   // linkedinLink: "https://github.com/harpalmodasiya"
    // },
    // // {
    //   name: "Yug Dobariya",
    //   designation: "Full Stack Web Developer",
    ...
    <section className="py-12 overflow-hidden">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-5xl font-bold bg-gradient-to-r from-white to-[#a62ad3] p-[2px] bg-clip-text text-transparent">
            Developers
          </h2>
        </div>
