          ...
          <div className="w-full justify-start items-center gap-8 grid lg:grid-cols-2 grid-cols-1">
            <div className="w-full flex-col justify-start lg:items-start items-center gap-10 inline-flex">
              <div className="w-full flex-col justify-start lg:items-start items-center gap-4 flex">
                <h2 className="bg-gradient-to-r from-[#a62ad3] to-[#d490ec] p-[2px] bg-clip-text text-transparent text-5xl font-bold font-manrope leading-normal lg:text-start text-center">
                ...
                😁Welcome to Lumen.Ai, the ultimate platform for turning static PDFs into dynamic, interactive learning resources. 
                  Designed for students, professionals, and lifelong learners, Lumen.Ai combines cutting-edge AI technology with 
