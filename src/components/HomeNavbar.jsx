    ...
    <nav className="bg-transparent w-full z-20 top-0 start-0">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <a href="#hero" onClick={(e) => handleNavClick(e, 'hero')} className="flex items-center space-x-3 rtl:space-x-reverse">
          ...
          <span className="self-center text-2xl font-semibold whitespace-nowrap" style={{ color: "#b27cc5" }}>
            Lumen.Ai
          </span>
        </a>
            ...
            {user ? (
              <Link href="/dashboard" className="w-full flex justify-center">
                <button className="group relative overflow-hidden rounded-lg bg-gradient-to-r from-white to-[#8623a9] p-[2px]">
                  <div className="relative rounded-lg bg-black px-4 py-2 transition-colors group-hover:bg-neutral-900">
