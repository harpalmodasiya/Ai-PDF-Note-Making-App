    ...
    <div className="min-h-screen bg-neutral-950 text-white">
      <div className="container mx-auto px-4 py-8 sm:py-12 lg:py-16">
        <div className="text-center space-y-4 mb-8 sm:mb-12">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-[#8623a9] p-[2px]">
          ...
          <div className="flex items-center justify-center gap-4 p-1">
            ...
            <button
              ...
              className="relative w-14 h-7 rounded-full bg-neutral-800"
            >
              <span className={`absolute left-1 top-1 h-5 w-5 rounded-full bg-gradient-to-r from-purple-500 to-[#8623a9] p-[2px] transition-transform duration-300 ${
                isYearly ? 'translate-x-7' : ''
              }`} />
            </button>
            <span className={`px-4 py-2 ${isYearly ? 'text-white' : 'text-gray-400'}`}>
              Yearly <span className="text-sm text-purple-400">Save 20%</span>
            </span>
          </div>
        </div>
          ...
          {plans.map((plan) => (
            <div
              ...
              className={`flex flex-col h-full relative rounded-3xl p-8 transition-all duration-300 hover:scale-105 ${
                plan.isPopular 
                  ? 'bg-gradient-to-b text-black  from-purple-200 via-purple-500 to-purple-800  shadow-xl'
                  : 'bg-neutral-800 backdrop-blur-sm shadow-lg hover:shadow-xl'
              }`}
            >
              {plan.isPopular && (
              ...
              <button
                className={`w-full rounded-2xl px-4 py-4 text-center font-medium transition-all duration-300 ${
                  plan.isPopular
                    ...
                    : 'bg-gradient-to-r from-purple-200 via-purple-400 to-purple-800 text-white hover:opacity-90'
                }`}
              >
                Get started
              </button>
