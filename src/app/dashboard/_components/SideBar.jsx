...
function SideBar({ onClose }) {
  ...
  return (
    <div className="shadow-xl h-screen bg-neutral-900 text-white relative flex flex-col border-r border-gray-600">
      {/* Close button - visible only on mobile */}
      <button 
        onClick={onClose}
        className="md:hidden absolute top-3 right-2 rounded-full hover:bg-neutral-700/80 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-gray-700"
      >
        {/* <X className="h-5 w-5" /> */}
      ...
      {/* Custom Alert */}
      {showAlert && (
        <div className="mx-4 p-4 rounded-xl bg-neutral-800/80 border border-neutral-700/50 text-sm backdrop-blur-sm shadow-lg transition-all duration-300 ease-in-out">
      ...
      {/* Footer Stats */}
      <div className="p-4 bg-neutral-800/30 border-t border-gray-700/50 space-y-3">
