      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogTrigger asChild>
          <Button
            ...
            className="group relative overflow-hidden rounded-lg bg-gradient-to-r from-white to-[#8623a9] p-[2px] py-6  w-full"
          >
            <div className="relative rounded-lg bg-neutral-900 px-6 py-3 transition-colors group-hover:bg-neutral-800 w-full flex items-center justify-center gap-2">
              <Upload
                size={20}
        ...
        <DialogContent className="bg-neutral-900 text-white border-neutral-700 max-w-md w-full mx-auto p-6">
          <DialogHeader>
          ...
          <div className="mt-6">
            <div
              ...
              ${dragActive ? "border-gray-600 bg-neutral-800" : "border-neutral-700"} 
              ${file ? "bg-neutral-800" : ""}
            ...
            <div className="mt-4 space-y-2">
              ...
              <Input
                ...
                className="bg-neutral-800 border-neutral-700 text-white placeholder-neutral-500 h-10"
              />
            </div>
          </div>
          ...
          <DialogFooter className="mt-6 flex gap-2">
            <Button
              ...
              className="flex-1 bg-neutral-800 hover:bg-neutral-700 text-white border border-neutral-700 h-10"
            >
              Cancel
            </Button>
            <Button
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center">
          <div className="bg-neutral-900/90 rounded-2xl p-8 max-w-md w-full mx-4 border border-neutral-800 shadow-2xl">
                      ...
                      <div className={`
                        ...
                        ${index === loadingStep 
                          ...
                          : index < loadingStep
                            ...
                            : "bg-neutral-800/50 text-gray-600"
                        }`}
                      >
                        {index < loadingStep ? (
