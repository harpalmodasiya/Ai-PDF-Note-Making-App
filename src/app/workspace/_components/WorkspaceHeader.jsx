...
function WorkspaceHeader({ fileName, fileId }) {
  ...
  const showToast = (message, type = 'success') => {
    ...
    toast.className = `
      ...
      ${type === 'success' ? 'bg-purple-500/95 text-white' : 'bg-red-500/95 text-white'} 
      shadow-lg z-50
  ...
  return (
    <div className="h-16 px-4 flex items-center justify-between bg-neutral-950 text-white border-b border-gray-700 relative">
      ...
      <div className="flex-1 max-w-md mx-4">
        <div className="px-3 py-1.5 border border-neutral-600 rounded-lg bg-neutral-800 shadow-sm">
      ...
      <div className="flex items-center space-x-3">
        <button
          onClick={handleSave}
          className="group relative rounded-lg bg-gradient-to-r from-purple-200 via-purple-500 to-purple-800 p-[2px]"
        >
          <div className="rounded-lg bg-neutral-900 px-3 py-1.5 transition group-hover:bg-neutral-800 flex items-center space-x-2">
        ...
        {/* Dropdown Menu */}
        {menuOpen && (
          <div className="absolute right-4 top-16 bg-neutral-800 rounded-lg shadow-md p-2 z-50">
            <Link href="/dashboard">
              <button className="group rounded-lg bg-gradient-to-r from-purple-200 via-purple-500 to-purple-800 p-[2px] block w-full text-left mb-2">
                <div className="rounded-lg bg-neutral-900 px-3 py-1.5 transition group-hover:bg-neutral-800 flex items-center space-x-2">
            ...
            <div className="block lg:hidden">
                ...
                <button onClick={()=>redirect('/logout')} className="group rounded-lg bg-gradient-to-r from-purple-200 via-purple-500 to-purple-800 p-[2px] block w-full text-left">
        ...
        <div className="hidden lg:flex items-center space-x-3">
          <Link href="/dashboard">
            <button className="group rounded-lg bg-gradient-to-r from-purple-200 via-purple-500 to-purple-800 p-[2px]">
              <div className="rounded-lg bg-neutral-900 px-3 py-1.5 transition group-hover:bg-neutral-800 flex items-center space-x-2">
                <GridIcon className="w-4 h-4 text-white" />
                <span className="text-sm text-white">Dashboard</span>
              </div>
          ...
          {/* <div className="hidden lg:block">
              ...
              <button onClick={()=>redirect('/logout')} className="group rounded-lg bg-gradient-to-r from-purple-200 via-purple-500 to-purple-800 p-[2px]">
                <div className="rounded-lg bg-neutral-900 px-3 py-1.5 transition group-hover:bg-neutral-800 flex items-center space-x-2">
                  <LogOutIcon className="w-4 h-4 text-white" />
                  <span className="text-sm text-white">Sign out</span>
                </div>
