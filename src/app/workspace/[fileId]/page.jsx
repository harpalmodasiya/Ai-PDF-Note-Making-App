...
function Workspace() {
  ...
  if (loading) {
    return (
      <div className="h-screen flex flex-col justify-center items-center bg-gradient-to-br from-neutral-900 via-neutral-800 to-neutral-900">
        {/* Logo Container */}
        ...
        <div className="flex flex-col items-center gap-4">
          <h2 className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-200 via-purple-500 to-purple-800">
            Loading your workspace
          </h2>

          {/* Loading Spinner */}
          <div className="relative">
            <div className="w-8 h-8 border-4 border-purple-500/30 rounded-full animate-spin border-t-purple-500"></div>
          </div>
  ...
  const ResizeHandle = () => (
    <PanelResizeHandle className="hidden lg:flex w-2 mx-1">
      <div className="h-full w-full flex items-center justify-center">
        <div className="w-1 h-16 bg-neutral-600 rounded-full cursor-col-resize hover:bg-neutral-500 transition-colors" />
      </div>
    </PanelResizeHandle>
  );
        ...
        <div className="flex-1 sm:p-4">
          <div className="block lg:hidden">
            <div className="flex-1 grid md:grid-cols-1 gap-1 sm:gap-3">
              {/* Text Editor Section */}
              <div className="h-[calc(100vh-7rem)] bg-neutral-800 rounded-lg shadow-md border border-neutral-700">
          ...
          <div className="hidden lg:block h-[calc(100vh-7rem)]">
            <PanelGroup direction="horizontal">
              ...
              <Panel defaultSize={50} minSize={20}>
                <div className="h-full bg-neutral-800 rounded-lg shadow-md border border-neutral-700">
                  <div className="h-full overflow-auto">
                    <TextEditor fileId={fileId} />
                  </div>
                </div>
              ...
              {/* PDF Viewer Panel */}
              <Panel defaultSize={50} minSize={20}>
                <div className="h-full bg-neutral-800 rounded-lg shadow-md border border-gray-700">
                  <div className="h-full overflow-hidden">
                    <PdfViewer fileUrl={fileInfo?.[0]?.fileUrl} />
                  </div>
                </div>
